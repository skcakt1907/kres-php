...
<section class="page-head">
  <div class="container">
    <h1>Galeri</h1>
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item active">Galeri</li></ol></nav>
  </div>
</section>
...
<section>
  <div class="container">
    <div class="section-head">
      <span class="badge-mini">Galerimiz</span>
      <h2>Etkinlik & Tesis <span>Galerimiz</span></h2>
    </div>
